...
| Action | Anon / session (OD-1 B) | Company Admin | Company HR | Company Finance | BeTaxed staff |
|---|---|---|---|---|---|
| Upload SS pass 1 | Y if OD-1 B | Y | Y | — | ops |
...
| Read benefit_case / saving_month | — | — | — | — | ops |
