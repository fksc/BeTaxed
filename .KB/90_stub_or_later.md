...
| SL-002 | 2026-08-20 | open | — | Company monthly SS upload API (workspace loop) |
| SL-003 | 2026-08-20 | open | — | `company_headcount_month` write path |
...
- **Status:** open
- **Resolved-date:** —
- **Related:** DEV-832, `KB/07_security_encryption.md`, `app/services/intake.py` (`_drop_leftover_niss_hashes`), `app/services/ss_ingest.py` (`_leftover_for_storage`)
...
- **Status:** open
- **Resolved-date:** —
- **Related:** DEV-832, `KB/10_product_flow.md#after-the-workspace-exists`, `KB/03_schema_ss_ingest.md`, `POST /v1/intakes/{id}/uploads`
...
- **Status:** open
- **Resolved-date:** —
- **Related:** DEV-834 (parked), `KB/03_schema_ss_ingest.md#table-company_headcount_month`, `KB/05_schema_benefit.md`, `KB/20_regime_ss_hiring_benefit.md` (application headcount test)
...
- **Status:** open
- **Resolved-date:** —
- **Related:** DEV-834 (parked), `KB/03_schema_ss_ingest.md#apply-and-diff`, `KB/02_schema_employment.md` (`LEAVE_STARTED` / `LEAVE_ENDED`), OD-4 leave not billable
...
- **Status:** open
- **Resolved-date:** —
- **Related:** DEV-834 (parked), `KB/10_product_flow.md`, `KB/40_permissions.md` (Admin/HR override status), `employment_event` `STATUS_OVERRIDE` / `SOURCE_CONFLICT`
...
- **Status:** open
- **Resolved-date:** —
- **Related:** `KB/02_schema_employment.md#table-employment_event`, `KB/20_regime_ss_hiring_benefit.md#cease-and-clawback`
