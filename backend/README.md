...
alembic upgrade head   # DEV-828 spine; DEV-830 encryption; DEV-831 SS raw ingest; DEV-832 intake flow
...
- `POST /v1/intakes/{id}/uploads` — multipart SS xlsx (`files` + `period_year_month`). Owner, session, or staff.
